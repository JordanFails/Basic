...
public final class PlayerUtil {
    ...
    public static void animateDeath(Player player) {
        ...
        final int entityId = EntityUtil.getFakeEntityId();
        ...
        try {
            ...
            SampleFeatures.get().getServer().getScheduler().runTaskLater(SampleFeatures.get(), () -> {
    ...
    public static void animateDeath(Player player, Player watcher) {
        ...
        try {
            ...
            SampleFeatures.get().getServer().getScheduler().runTaskLater(SampleFeatures.get(), () -> ((CraftPlayer)watcher).getHandle().playerConnection.sendPacket(new PacketPlayOutEntityDestroy(new int[]{entityId})), 40L);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
