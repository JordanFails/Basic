...
public enum PartnerPackage {
    PARTNER("PARTNER", CC.translate("&d&lPartner Shard"), Basic.get().getConfig().getStringList("package.lore"), new ItemStack(Material.PRISMARINE_SHARD, 1), Enchantment.DURABILITY, 10);
