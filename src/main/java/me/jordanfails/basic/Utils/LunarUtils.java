...
public class LunarUtils {
    ...
    public static String checkLC(Player player) {
        return LunarClientAPI.getInstance().isRunningLunarClient(player) ? translate(Basic.getInstance().getConfig().getString("OTHER.ENABLED")) : translate(Basic.getInstance().getConfig().getString("OTHER.DISABLED"));
    }
